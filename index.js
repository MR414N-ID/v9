...
Lexxy.sendMessage(from, gfx, image, { quoted: mek, caption: '*Logo By Alan Gans*'})
break
case 'gfx3':
case 'gfx4':
if (args.length ==0) return reply(`Text Nya Mana? Contohnya\n${prefix+command} Alan Gans`)
sticWait(from)
ini_txt1 = args[0]
ini_txt1 = args[1]
...
Lexxy.sendMessage(from, bf, image, { quoted: flexx, caption: 'Logo By Alan Gans' })
break
case 'girlneko':
case 'sadboy':
if (isBanned)return sticBanned(from)
